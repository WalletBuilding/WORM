...
This means one can have an always-on wormd instance running, and another local wormd/worm-qt instance which connects to this node and receives blocks from it.
