...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WormTestFramework
    pass

class ExampleTest(WormTestFramework):
    # Each functional test is a subclass of the WormTestFramework class.
    ...
    def custom_method(self):
        ...
        WormTestFramework class so other tests can use it."""
