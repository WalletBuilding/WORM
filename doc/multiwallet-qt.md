...
In order to support loading of multiple wallets in worm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is worm.cpp.
...
Changes to worm.cpp
----------------------
worm.cpp is the entry point into worm-qt, and as such, will require some minor modifications to provide hooks for
