...
////////////////////////////////////////////////////////////// // worm
	void setWormSchedule(EVMSchedule _wormSchedule) const { wormSchedule = _wormSchedule; }

	EVMSchedule& getWormSchedule() const { return wormSchedule; }
...
private:
	...
	mutable EVMSchedule wormSchedule; // worm
