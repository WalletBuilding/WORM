...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Wormcore worm-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  worm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded worm transaction") + "\n" +
                               "  worm-tx [options] -create [commands]   " + _("Create hex-encoded worm transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded worm transaction
