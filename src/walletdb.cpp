...
bool CWalletDB::WriteWormNodeConfig(std::string sAlias, const CWormNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadWormNodeConfig(std::string sAlias, CWormNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseWormNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;
