...
#include "ui_wormnodeconfigdialog.h"

#include <QModelIndex>

WormNodeConfigDialog::WormNodeConfigDialog(QWidget *parent, QString nodeAddress, QString privkey) :
    QDialog(parent),
    ui(new Ui::WormNodeConfigDialog)
{
    ui->setupUi(this);
...
WormNodeConfigDialog::~WormNodeConfigDialog()
{
    delete ui;
}
