...
UpdateInfoDialog::DialogResult UpdateInfoDialog::showUpdateInfo(QList<WormUpdater::WormUpdateInfo> updates, bool &runAsAdmin, bool editable, bool detailed, QWidget *parent)
{
	if(!detailed) {
...
void QtWormUpdater::UpdateInfoDialog::on_acceptButton_clicked()
{
...
void QtWormUpdater::UpdateInfoDialog::on_delayButton_clicked()
{
