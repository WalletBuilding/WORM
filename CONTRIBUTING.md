Contributing to Wormcore
============================

The Wormcore project operates an open contributor model where anyone is
...
The following applies to code changes to the Wormcore project, and is not to be
confused with overall WORM Network Protocol consensus changes.

Whether a pull request is merged into Wormcore rests with the project merge
...
Patches that change WORM consensus rules are considerably more involved than
...
Where a patch set proposes to change the WORM consensus, it must have been
...
The project leader is the release manager for each Wormcore release.
